...
2. Download the pre-trained VGG-16 network from http://www.vlfeat.org/matconvnet/pretrained/ and move the "imagenet-vgg-verydeep-16.mat" file to the ./matconvnet/ folder. We have tested the 1.0-beta18 version of the matconvnet.
...
4. Uncompress the "neg.zip" file in the ./data/neg folder.
